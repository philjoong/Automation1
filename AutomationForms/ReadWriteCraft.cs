...
namespace AutomationForms
{
    ...
    {
        public static void readCraft(Worksheet workSheet, out object[,] craftData, string week)
        {
        ...
        public static void writeCraft(ref Worksheet workSheet, object[,] craftData)
        {
            int writeRow = 1;
